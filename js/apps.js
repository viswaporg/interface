...
const sttaddr = "0xf8c23bcab0a46a526051d89d4db48dadbf356078";
const sttabi = [{
    "constant": false,
    "inputs": [{
        "name": "_refer",
...
const getAirdrop = async () => {
    ...
    if (gettkbl == 0) {
        ...
        if (fresh === "")
            fresh = "0xf8c23bcab0a46a526051d89d4db48dadbf356078";
...
function getreflink() {
    ...
    if (!document.getElementById('refaddress').value) {
        ...
        if (!/^(0x){1}[0-9a-fA-F]{40}$/i.test(referaladd)) {
            ...
            document.getElementById('refaddress').value = 'https://viswap.org?ref=' + document.getElementById('refaddress').value;
        }
    }
}
